...
namespace WarhammerGameManager.Entities.EntityFramework.WarhammerNarrative.Migrations
{
    ...
    [Migration("20231121123651_Migration_v0.2")]
    partial class Migration_v02
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FactionPlayer", b =>
                {
                    b.Property<long>("FactionsId")
                        .HasColumnType("bigint");

                    b.Property<long>("PlayerFactionsId")
                        .HasColumnType("bigint");

                    b.HasKey("FactionsId", "PlayerFactionsId");

                    b.HasIndex("PlayerFactionsId");

                    b.ToTable("FactionPlayer");
                });
            ...
            modelBuilder.Entity("FactionPlayer", b =>
                {
                    b.HasOne("WarhammerGameManager.Entities.EntityFramework.WarhammerNarrative.TableModels.Faction", null)
                        .WithMany()
